<?php
    ...
    $result = mysqli_query($koneksi, "SELECT email FROM dosen WHERE email = '$email'");
    ...
    mysqli_query($koneksi, "INSERT INTO dosen VALUES ('2','Redo','Pria','1980-18-01','$email','$password','123123123','redo.jpg','Dosen')");
